...
exports.handleAll = function (req, res, options) {
	return function (err) {
		if (err instanceof Sequelize.UniqueConstraintError) {
			exports.handleUnique(req, res, options.unique)(err);
			return;
		}

		if (err instanceof Sequelize.ForeignKeyConstraintError) {
			exports.handleForeign(req, res, options.foreign)(err);
			return;
		}

		if (err instanceof Sequelize.ValidationError) {
			exports.handleValidation(req, res, options.validation)(err);
			return;
		}

		exports.handleInternal(req, res)(err);
	};
};
